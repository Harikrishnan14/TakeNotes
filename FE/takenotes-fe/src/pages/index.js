    ...
    <div className='py-4 px-30'>
      ...
      <div className='grid grid-cols-4 gap-4 overflow-auto py-1' style={{ height: 'calc(100vh - 150px)' }}>
        {Array.from({ length: 10 }).map((_, index) => (
          <div className='border-2 border-amber-900 rounded-lg overflow-hidden w-full h-[235px] bg-white cursor-pointer transition-shadow duration-200 hover:-translate-y-1 hover:shadow-lg' key={index.toString()}>
